...
const PaymentButton: React.FC<PaymentButtonProps> = ({
  ...
  switch (true) {
    ...
    case isManual(paymentSession?.provider_id):
      return (
        <ManualTestPaymentButton notReady={notReady} locale={locale as string} data-testid={dataTestId} />
      )
    default:
      return (
...
const ManualTestPaymentButton = ({ notReady, locale }: { notReady: boolean; locale: string }) => {
  // const [errorMessage, setErrorMessage] = useState<string | null>(null)

  const onPaymentCompleted = async () => {
    await placeOrder(undefined, locale).catch((err) => {
      // toast.error({
